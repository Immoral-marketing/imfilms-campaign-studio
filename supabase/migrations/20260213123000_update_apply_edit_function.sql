-- Update apply_approved_film_edit logic to handle campaign budget and platforms
...
BEGIN
  ...
  -- 2. Aplicar cambios a la tabla CAMPAIGNS (Presupuesto)
  ...
  -- Si 'platforms' está presente en la propuesta, reemplazamos las plataformas existentes
